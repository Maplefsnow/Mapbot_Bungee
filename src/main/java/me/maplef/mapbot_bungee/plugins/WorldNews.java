...
import me.maplef.mapbot_bungee.utils.DownloadImage;
import me.maplef.mapbot_bungee.utils.HttpClient4;
...
public class WorldNews implements MapbotPlugin {
    ...
    public MessageChain SendNews(Long groupID){
        File tmp = new File(".\\plugins\\Mapbotbungee\\temp.jpg");
        ...
        try {
            newsImg = new File(DownloadImage.download(imageUrl, "temp", ".\\plugins\\Mapbotbungee"));
